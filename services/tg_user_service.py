...
from utils.object_shortcuts import get_tg_user_by_tg_id, get_tg_users_list_by_category, delete_tg_user
from utils.perm import CheckUserPermission


def get_user(tg_id: int, db: Session) -> TgUser:
...
def delete_user(tg_id: int, db: Session) -> dict:
    return delete_tg_user(tg_id, db)
